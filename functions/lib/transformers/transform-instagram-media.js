...
const transformInstagramMedia = rawMedia => {
    const { caption, comments_count: commentsCounts, children, id, like_count: likeCount, media_type: mediaType, media_url: mediaURL, permalink, shortcode, thumbnail_url: thumbnailURL, timestamp, username, } = rawMedia;
...
//# sourceMappingURL=transform-instagram-media.js.map
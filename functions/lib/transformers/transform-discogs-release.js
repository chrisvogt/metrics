...
const transformDiscogsRelease = rawRelease => {
    const { id, instance_id: instanceId, date_added: dateAdded, rating, basic_information: basicInfo, folder_id: folderId, notes, resource // Raw resource data from batch fetching
     } = rawRelease;
    const { id: basicId, master_id: masterId, master_url: masterUrl, resource_url: resourceUrl, thumb, cover_image: coverImage, title, year, formats, labels, artists, genres, styles } = basicInfo;
...
//# sourceMappingURL=transform-discogs-release.js.map
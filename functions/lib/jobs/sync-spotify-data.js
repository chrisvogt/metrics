...
import { CLOUD_STORAGE_IMAGES_BUCKET, CLOUD_STORAGE_SPOTIFY_PLAYLISTS_PATH, DATABASE_COLLECTION_SPOTIFY, IMAGE_CDN_BASE_URL } from '../lib/constants.js';
...
const syncSpotifyTopTracks = async () => {
    ...
    const { display_name: displayName, external_urls: { spotify: profileURL } = {}, followers: { total: followersCount } = {}, id, images, } = userProfile;
...
//# sourceMappingURL=sync-spotify-data.js.map
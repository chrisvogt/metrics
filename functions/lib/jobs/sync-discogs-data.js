...
import { CLOUD_STORAGE_IMAGES_BUCKET, DATABASE_COLLECTION_DISCOGS, DISCOGS_USERNAME } from '../lib/constants.js';
/*
...
const syncDiscogsData = async () => {
    try {
        ...
        const enhancedReleasesTyped = enhancedReleases;
        ...
        const mediaToDownloadTyped = mediaToDownload;
...
//# sourceMappingURL=sync-discogs-data.js.map